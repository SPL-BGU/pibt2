...
public:
  ...
  bool validate(const Config& starts, const Config& goals, int field_of_view_radius, int k) const;
  bool validate(const Config& starts, int field_of_view_radius, int k) const;
